# Generated by Django 4.2.16 on 2024-12-17 03:04
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "interest",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="stock.interest"
                    ),
                ),
                (
                    "user",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "industry_codes",
                    models.ManyToManyField(
                        related_name="themes", to="stock.industrycode"
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "theme",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="stock.theme"
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "article",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="stock.article"
                    ),
                ),
                (
                    "like_comment",
        ...
        migrations.AddField(
            ...
            name="theme",
            field=models.ForeignKey(
                null=True, on_delete=django.db.models.deletion.CASCADE, to="stock.theme"
            ),
        ),
    ]
